...
<head>
    ...
    <meta name="description" content="Heritage Pedia - Nepal's Cultural Legacy. Explore the rich heritage of Nepal.">
    <title>Heritage Pedia</title>
...
<div class="hero-section">
    ...
    <div class="content-wrapper">
        <div class="title-container">
            <h1 class="main-title">HERITAGE<br>PEDIA</h1>
        </div>
