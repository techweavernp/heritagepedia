...
<header class="page-header">
    ...
    <div class="header-title">{{$heritage->city->district->name}}</div>
...
{{--            </div>--}}
            ...
            @foreach($heritage->heritage_details as $detail)
                @php
                    $langCode = strtolower($detail->lang->code);
//                    $flagMap = [
//                        'np' => 'np',
//                        'en' => 'us',
//                        'hn' => 'in',  // Hindi
...
//                        'jp' => 'jp',  // Japanese
//                    ];
//                    $flag = $flagMap[$langCode] ?? 'us';
                @endphp

                <div class="lang-option"
                     data-lang="{{ $detail->lang->name }}"
                     data-url="https://heritagepedia.info/{{ $heritage->code }}-{{ $langCode }}">
                    <span class="fi fi-{{ $langCode }}"></span> {{ $detail->lang->name }}
                </div>
            @endforeach
        </div>
    </div>
...
<section class="hero-section">
    <div class="hero-bg">
        ...
        <img src="{{ asset('storage/' . $heritage->feature_image) }}"
    ...
    <div class="hero-content">
        ...
        <div class="location">
            <i class="fas fa-map-marker-alt"></i> {{$heritage->street}}
        </div>
    </div>
</section>
