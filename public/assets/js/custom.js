(function($) {
	...
	/*========== scroll to top  ==========*/
	var scrollPath = document.querySelector('.scroll-up path, .scroll-two path path');
	...
	jQuery(window).on('scroll', function() {
		if (jQuery(this).scrollTop() > offset) {
			jQuery('.scroll-up, .scroll-two').addClass('active-scroll');
		} else {
			jQuery('.scroll-up, .scroll-two').removeClass('active-scroll');
		}
	});
	jQuery('.scroll-up, .scroll-two').on('click', function(event) {
